    ...
    <div className="px-3 py-2 space-y-1.5">
      <div className="flex items-center gap-1.5">
        ...
        {editing ? (
          ...
          <span onDoubleClick={() => setEditing(true)} className="flex-1 text-xs text-gray-700 truncate cursor-text" title="Double-click to rename — also the label shown above the ring">
            {chart.title}
          </span>
        )}
  ...
  return (
    <div className="flex-1 flex flex-col overflow-y-auto">
      <div className="px-3 py-2 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white gap-1.5 flex-wrap">
        <span className="text-xs text-gray-500 shrink-0">Radial Charts</span>
