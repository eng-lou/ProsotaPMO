            ...
            >
              ...
              >
                ...
                <button
                  ...
                  title="Expand"
                  className="no-print ml-auto text-gray-400 dark:text-prosota-muted hover:text-gray-700 dark:hover:text-prosota-paper"
                >
                  ⤢
                </button>
              ...
              <div
                className="no-print absolute bottom-0 right-0 w-4 h-4 cursor-se-resize"
